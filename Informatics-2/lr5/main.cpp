...
namespace Pharmacy {
    ...
    class Customer : public Abstract_user{
        public:
        void sayHi(){
            cout << "Hi, I'm customer" << endl;
        }
    };

    class Homeless : public Abstract_user{
        public:
        void sayHi(){
            cout << "Hi, I'm Homeless" << endl;
        }
    };
...
int main() {
    ...
    Pharmacy::Worker worker("Vasya", "123456789");
    // create pointer to calcsum
        int (*add)(int, int) = calcSum;
    ...
    // Worker -> Owner, Seller, Security, Cleaner, Admin
    // Building -> Casa, Storage

    // Copy
    Diamond::First first;
    Diamond::First second(first);

    // Diamond
    Diamond::Fourth fourth;
    fourth.one;

    // pointer on object
    Pharmacy::Worker *worker1 = new Pharmacy::Worker("Vasya", "123456789");
